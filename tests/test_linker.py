...
from workspacebrain.core.linker import AI_RULE_FILES, AI_RULES_DIR, BrainLinker, unlink_project
...
class TestBrainLinker:
    ...
    def test_link_generates_ai_rule_files(
        ...
        assert wbrain_dir.exists(), ".wbrain directory should exist"

        # Check all AI rule files were generated in .wbrain/
        for rule_file in AI_RULE_FILES:
            rule_path = wbrain_dir / rule_file
            assert rule_path.exists(), f"{AI_RULES_DIR}/{rule_file} should exist"
    ...
    def test_link_single_project(
        ...
        # Check AI rule files in .wbrain/ directory
        wbrain_dir = project / AI_RULES_DIR
        for rule_file in AI_RULE_FILES:
            assert (wbrain_dir / rule_file).exists()
    ...
    def test_link_is_idempotent(
        ...
        # Modify a generated file in .wbrain/ directory
        wbrain_dir = project / AI_RULES_DIR
    ...
    def test_ai_rule_files_contain_project_type(
        ...
        # Check CLAUDE.md contains project type (in .wbrain/ directory)
        wbrain_dir = project / AI_RULES_DIR
        claude_content = (wbrain_dir / "CLAUDE.md").read_text()
...
class TestUnlinkProject:
    ...
    def test_unlink_removes_generated_rule_files(
        ...
        """Test that unlink removes .wbrain/ directory with generated AI rule files."""
        project = temp_workspace_with_brain / "app"
        project.mkdir()
        ...
        # .wbrain directory and all rule files should exist
        wbrain_dir = project / AI_RULES_DIR
        ...
        # .wbrain directory should be removed
        assert not wbrain_dir.exists()

...
class TestBrainLinker:
    ...
    def test_link_generates_ai_rule_files(
        ...
        """Test that link generates AI rule files in project root."""
        project = temp_workspace_with_brain / "my-app"
        project.mkdir()
        ...
        # Check AI rule files were generated in project root
        for rule_file in AI_RULE_FILES:
            rule_path = project / rule_file
            assert rule_path.exists(), f"{rule_file} should exist in project root"

            content = rule_path.read_text()
            assert "GENERATED BY WORKSPACEBRAIN" in content
            assert "DO NOT EDIT" in content

        # Check generated files are in result (4 files now: CLAUDE.md, .cursorrules, .windsurfrules, AI.md)
    ...
    def test_link_single_project(
        ...
        # Check AI rule files in project root
        for rule_file in AI_RULE_FILES:
    ...
    def test_link_is_idempotent(
        ...
        # Get a generated file from project root
    ...
    def test_link_with_force_regenerates(
        ...
        # Modify a generated file in project root
        claude_md = project / "CLAUDE.md"
    ...
    def test_ai_rule_files_contain_project_type(
        ...
        # Check CLAUDE.md contains project type (in project root)
...
class TestUnlinkProject:
    ...
    def test_unlink_removes_generated_rule_files(
        ...
        """Test that unlink removes generated AI rule files from project root."""
        project = temp_workspace_with_brain / "app"
        project.mkdir()
        ...
        # All rule files should exist in project root
        for rule_file in AI_RULE_FILES:
            assert (project / rule_file).exists()
